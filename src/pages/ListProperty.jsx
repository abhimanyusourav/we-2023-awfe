...
const ListProperty = () => {
  ...
  const handleOnSubmit = async (ev) => {
    ...
    for(const file of files) {
      ...
      imgList.push(`https://firebasestorage.googleapis.com/v0/b/lb-we-2023-66727.appspot.com/o/properties%2F${randomFileName}?alt=media&token=7a114d0e-b705-4f77-abbd-cc01afaae2ed`)
    }
